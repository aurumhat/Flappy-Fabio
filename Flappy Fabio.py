...
pygame.display.set_caption('Flappy Fabio')
...
def draw_player(x_pos, y_pos):
    ...
    if y_change < 0: #to make flames from jetpack while jumping
            flame1red = pygame.draw.rect(screen, red, [x_pos - 20, y_pos + 29, 7, 20], 0, 2)
            flame1yellow = pygame.draw.rect(screen, yellow, [x_pos - 18, y_pos + 30, 3, 18], 0, 2)
            flame2red = pygame.draw.rect(screen, red, [x_pos - 10, y_pos + 29, 7, 20], 0, 2)
            flame2yellow = pygame.draw.rect(screen, yellow, [x_pos - 8, y_pos + 30, 3, 18], 0, 2)
    return play


#drawing obstacles, position, collide
...
#if player touch y edge, and while jumping            
